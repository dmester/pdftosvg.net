...
{
    internal class PdfDocEncoding : SingleByteEncoding
    {
        // Extracted from PDF spec 1.7 page 656.
        ...
        private static readonly string?[] chars = new[]
        {
            ...
            "\u2039", "\u203a", "\u2212", "\u2030", "\u201e", "\u201c", "\u201d", "\u2018", // 210 - 217
            "\u2019", "\u201a", "\u2122", "\ufb01", "\ufb02", "\u0141", "\u0152", "\u0160", // 220 - 227
            "\u0178", "\u017d", "\u0131", "\u0142", "\u0153", "\u0161", "\u017e", nullchar, // 230 - 237
            "\u20ac", "\u00a1", "\u00a2", "\u00a3", "\u00a4", "\u00a5", "\u00a6", "\u00a7", // 240 - 247
            "\u00a8", "\u00a9", "\u00aa", "\u00ab", "\u00ac", nullchar, "\u00ae", "\u00af", // 250 - 257
            "\u00b0", "\u00b1", "\u00b2", "\u00b3", "\u00b4", "\u00b5", "\u00b6", "\u00b7", // 260 - 267
            "\u00b8", "\u00b9", "\u00ba", "\u00bb", "\u00bc", "\u00bd", "\u00be", "\u00bf", // 270 - 277
        ...
        public PdfDocEncoding() : base(chars, glyphNames) { }
    }
}
