...
{
    internal class CompactFontPredefinedCharsets
    {
        // CFF spec #5176 - Appendix C

        private static readonly int[] isoAdobe = new int[]
        {
        ...
        private static readonly int[] expert = new int[]
        {
        ...
        private static readonly int[] expertSubset = new int[]
        {
        ...
        public static readonly int[][] Charsets = new[]
        {
            isoAdobe,
            expert,
            expertSubset,
