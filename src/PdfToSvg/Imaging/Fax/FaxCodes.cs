...
namespace PdfToSvg.Imaging.Fax
{
    ...
    {
        public static readonly FaxCodeTable CodingModes;
        public static readonly FaxCodeTable BlackRunLengthCodes;
        public static readonly FaxCodeTable WhiteRunLengthCodes;
        ...
        public const int EndOfLine = 0b000000000001;
        public const int EndOfLineCodeLength = 12;

        static FaxCodes()
        {
            BlackRunLengthCodes = new FaxCodeTable(blackCodes);
            WhiteRunLengthCodes = new FaxCodeTable(whiteCodes);

            CodingModes = new FaxCodeTable(new int[]
            {
                Pass, Pass,
                Horizontal, Horizontal,
                VerticalRight1, VerticalRight1,
                VerticalRight2, VerticalRight2,
                VerticalRight3, VerticalRight3,
                VerticalLeft1, VerticalLeft1,
                VerticalLeft2, VerticalLeft2,
                VerticalLeft3, VerticalLeft3,
                Vertical0, Vertical0,
            });
        }
